...
require('ngcytoscape_kkomenan/dist/ngCytoscape');
...
angular.module('app', ['oitozero.ngSweetAlert', 'ngTable', 'ngMaterial', 'ngCytoscape']);
...
angular.module('app').controller('SourceCodeController', ['$scope', '$http', 'SweetAlert', 'cytoData', SourceCodeController]);
