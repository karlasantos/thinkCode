 ...
 */
class Language extends \SourceCode\Model\Entity\Language implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'SourceCode\\Model\\Entity\\Language' . "\0" . 'id', '' . "\0" . 'SourceCode\\Model\\Entity\\Language' . "\0" . 'name', '' . "\0" . 'SourceCode\\Model\\Entity\\Language' . "\0" . 'initialCodeStructure', '' . "\0" . 'SourceCode\\Model\\Entity\\Language' . "\0" . 'endCodeStructure', '' . "\0" . 'SourceCode\\Model\\Entity\\Language' . "\0" . 'initialVertexName', '' . "\0" . 'SourceCode\\Model\\Entity\\Language' . "\0" . 'endVertexName', '' . "\0" . 'SourceCode\\Model\\Entity\\Language' . "\0" . 'ifThenNameVertex', '' . "\0" . 'SourceCode\\Model\\Entity\\Language' . "\0" . 'diversionCommands', '' . "\0" . 'SourceCode\\Model\\Entity\\Language' . "\0" . 'logicalConnectives', '' . "\0" . 'SourceCode\\Model\\Entity\\Language' . "\0" . 'dataTypes', '' . "\0" . 'SourceCode\\Model\\Entity\\Language' . "\0" . 'specialCharacters'];
        }
