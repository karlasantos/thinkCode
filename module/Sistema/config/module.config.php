...
return array(
    'controllers' => array(
        'invokables' => array(
            ...
            'Sistema\Controller\Auth' => 'Sistema\Controller\AuthController'
        ),
    ),
    'router' => array(
        'routes' => array(
            ...
            'auth' => array(
                ...
                'options' => array(
                    ...
                    'defaults' => array(
                        'controller' => 'Sistema\Controller\Auth',
                        'action'     => 'index',
                    ),
                )
            ),
            ...
            'recover-password' => array(
                'type'    => 'segment',
                'options' => array(
                    'route'       => '/recover-password[/:action][/:id]',
                    'constraints' => array(
                        'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                    ),
                    'defaults' => array(
            ...
            // using the path /sistema/:controller/:action
            'sistema' => array(
                'type'    => 'Literal',
                'options' => array(
                    'route'    => '/sistema',
